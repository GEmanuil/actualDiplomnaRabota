...
<div class="questionActionBorder">
    <h1 id="makingTestText">
        ...
        <form action="${pageContext.request.contextPath}/testAction2" method="get">
            <input id="1" type="radio" name="checkBox" value="answer1" required>
            <label for="1" class="Register LN">A) <%=answer1%></label><br><br>

            <input  id="2" type="radio" name="checkBox" value="answer2">
            <label for="2" class="Register LN">B) <%=answer2%></label><br><br>


            <input  id="3" type="radio" name="checkBox" value="answer3">
            <label for="3" class="Register LN">C) <%=answer3%></label><br><br>


            <input  id="4" type="radio" name="checkBox" value="answer4">
            <label for="4" class="Register LN">D) <%=answer4%></label><br><br>
